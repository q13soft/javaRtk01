...
PS: В связи с тем, что в отпуске и доступ к старому репозимторию https://github.com/q7soft/javaRtk01 ограничен, сделал его форк и 8 работу добавил в новый репозиторий https://github.com/q13soft/javaRtk01   
